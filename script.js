...
const semestres = [
  ...
  ["Bioquímica General","Morfología Básica","Ética","Tecnología Médica en el Equipo de Salud","Bioseguridad y Procedimientos Diagnósticos","Psicología de Atención"],
  ["Integrado Fisio‑Farmacología 1","Salud Poblacional","Infectología Básica","Fundamentos de Física Médica","Matemática Integrada"],
  ...
  ["Electivo 3","Tomografía Computada 2","Salud Digital","Radioterapia","Resonancia Magnética","Hito Evaluativo Interprofesional"],
  ["Gestión Desarrollo Profesional","Análisis Clínico Integrado","Taller Investigación","Electivo A","Electivo B","Sistemas Acreditación"],
  ["Internado"]
];
...
const prereq = {
  ...
  "Taller Investigación": ["Metodología Investigación"],
